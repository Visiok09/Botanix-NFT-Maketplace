...
import { clearLocalStorage } from '../context/walletStorage';
...
const ButtonGroup = ({
  ...
  return (
    <div className="button-group">
      {currentAccount && walletConnected ? (
        <Button
          btnName="Create"
          classStyles={
...
const Navbar = () => {
  ...
  useEffect(() => {
    //console.log('Cuurent', currentChainId, walletConnected);
    if (!walletConnected) {
      ...
      switch (currentChainId) {
        case 421614:
          setSelectedChainName('Arbitrum Sepolia');
          break;
        case 11155420:
          setSelectedChainName('Op Sepolia');
          break;
        case 3636:
          setSelectedChainName('Botanix Testnet');
          break;
  ...
  }, [currentChainId, walletConnected]);
            ...
            <div className=" p-4 flex-col text-center h-full ">
              ...
              <p className="font-poppins dark:text-white text-nft-black-1 font-normal text text-sm minlg:text-xl mt-2">
                ...
                <span className=" text-xl ">
                  ...
                  4. Bridge NFT:{' '}
                  <span className="font-semibold ">
                    <span className="text-amber-300">7 pts</span> for each
                    successful bridge NFT .
                  </span>
                </span>
              </p>
            </div>
