...
const PaymentBodyCmp = ({ nft, nftCurrency }) => (
  <div className="flex flex-col">
    ...
    <div className="flexBetween mt-10">
      ...
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal text text-sm minlg:text-xl">
        0.00005 <span className="font-semibold">{nftCurrency}</span>
      </p>
    </div>
    <div className="flexBetween mt-10">
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal text text-base minlg:text-xl">
      ...
      <p className="font-poppins dark:text-white text-nft-black-1 font-normal text text-sm minlg:text-xl">
        {(parseFloat(nft.price) + 0.00005).toFixed(5)}{' '}
...
const NFTDetails = () => {
  ...
  // console.log('NFT', currentAccount === nft.seller);
  return (
          ...
          {currentAccount === nft.seller.toLowerCase() ? (
            ...
            <>
              ...
              <Button
                btnName="Bridge"
                classStyles="mr-5 sm:mr-0 sm:mb-5 rounded-xl"
                handleClick={() => router.push(`/bridge-nfts?`)}
              />
            </>
          ) : (
            <Button
