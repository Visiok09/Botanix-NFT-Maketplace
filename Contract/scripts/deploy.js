...
async function main() {
  ...
  const ONFT721 = await hre.ethers.getContractFactory('BotanixLz');

  const provider = hre.ethers.provider; // Using the provider from Hardhat environment
  ...
  console.log('address BotanixLz', onft721.target);
